...
;  print exposure1
  ...
  ;set exposure ((12.5 * (F-stopFloat ^ 2)) / (ShutterSpeedFloat * ISOFloat)) - cdpm2
  ;set exposure ((log exposure 2) + 3) 
  ;set exposure (((1.44279 * ln(exposure)) + 3))
end
...
to flashDistance
  ...
  let allISOList [[3.5 7 20] [5 10 28][7 14 40]]
  let currentPower 0
  let localISO 0
...
EVDropdown
EVDropdown
"-2 - Full moonlight" "-1" "0" "1" "2 - distant lit buildings" "3" "4 - Christmas Tree Lights, floodlights" "5 - Night traffic" "6 - Indoor Party" "7 - Amusement parks, offices" "8 - Flourescent lighting, streetlights, circus" "9 - Neon and signage, stage shows" "10 - After sunset" "11 - Shady" "12 - Overcast, at sunset" "13 - Cloudy" "14 - Hazy" "15 - Sunny" "16 - Sand and Snow"
8
